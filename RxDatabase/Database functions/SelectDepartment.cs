...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DemoApplication.DatabaseTab.CmbDepartment' at 449;15.", repo.DemoApplication.DatabaseTab.CmbDepartmentInfo, new RecordItemIndex(0));
            repo.DemoApplication.DatabaseTab.CmbDepartment.Click("449;15");
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DepartmentList.Development' at 201;8.", repo.DepartmentList.DevelopmentInfo, new RecordItemIndex(1));
            repo.DepartmentList.Development.Click("201;8");
            Delay.Milliseconds(200);
